  ...
  return (
    <header className="app-header-nav">
      ...
      <div className="header-controls">
        ...
        >
          {theme === 'dark' ? (
            <span className="material-icons theme-icon-material" style={{ fontSize: '14px' }}>light_mode</span>
          ) : (
            <span className="material-icons theme-icon-material" style={{ fontSize: '14px' }}>dark_mode</span>
          )}
        </button>
      </div>
    </header>
